...
import spaceinvaders.utils.MissileException;
    ...
    public class SpaceInvadersTest {
        ...
        public void test_VaisseauAvance_DeplacerVaisseauVersLaDroite() {
            ...
            spaceinvaders.faireDeplacement().deplacerSpriteVersLaDroite(this.spaceinvaders.recupererVaisseau());
            assertEquals("" + 
            "...............\n" + 
            "...............\n" +
            "...............\n" + 
        ...
        public void test_VaisseauAvance_DeplacerVaisseauVersLaGauche() {
           ...
           spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(3,2),new Position(7,9), 3);
           spaceinvaders.faireDeplacement().deplacerSpriteVersLaGauche(this.spaceinvaders.recupererVaisseau());
        ...
        public void test_MissileDisparait_QuandIlCommenceASortirDeEspaceJeu() {
     	   ...
     	   for (int i = 1; i <8 ; i++) {
     		   spaceinvaders.faireDeplacement().deplacerMissile();
     	   }
    	...
    	public void test_Envahisseur_DeplacerEnvahisseurVersLaGauche() {
            ...
            spaceinvaders.faireDeplacement().deplacerSpriteVersLaGauche(this.spaceinvaders.recupererEnvahisseurs().get(0));
    	...
    	public void test_Envahisseur_DeplacerEnvahisseurVersLaDroite() {
    		spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2, 2), new Position(3,9), 1);
    		spaceinvaders.faireDeplacement().deplacerSpriteVersLaDroite(this.spaceinvaders.recupererEnvahisseurs().get(0));
        ...
        public void test_PlusieursEnvahisseursDeplacementADroiteDansEspaceJeu() {
        	...
        	spaceinvaders.faireDeplacement().deplacerSpriteVersLaDroite(spaceinvaders.recupererEnvahisseurs().get(0));
        	spaceinvaders.faireDeplacement().deplacerSpriteVersLaDroite(spaceinvaders.recupererEnvahisseurs().get(1));
        ...
        @Test
        public void test_positionnerVaisseauEtEnvahisseur() {
        	spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(4, 2), new Position(3,9), 1);
        ...
        @Test
        public void test_PositionVaisseauEtTireVaisseauEtPositionEnvahisseurEtTireEnvahisseur() {
        	spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(4, 2), new Position(3,9), 1);
        	spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2, 2), new Position(7,3), 1);
        	
        	spaceinvaders.tirerMissileVaisseau(new Dimension(2,2),1);
        	spaceinvaders.tirerMissileEnvahisseur(new Dimension(2,2),1, 0);
        ...
        @Test
        public void test_CollisionMissileVaisseau_MissileEnvahisseur() {
        	spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(4, 2), new Position(3,9), 1);
        	spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2, 2), new Position(4,3), 1);
        	
        	spaceinvaders.tirerMissileVaisseau(new Dimension(2,2),1);
        	spaceinvaders.tirerMissileEnvahisseur(new Dimension(2,2),1, 0);
        	
        	spaceinvaders.faireDeplacement().deplacerMissile();
        	spaceinvaders.faireCollision().collisionMissileEnvahisseur_MissileEnvahisseur();
        ...
        @Test
        public void test_CollisionMissileVaisseau_Envahisseur() {
        	spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(4, 2), new Position(3,9), 1);
        	spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2, 2), new Position(4,6), 1);
        ...
        @Test
        public void test_MissileEnvahisseurSortEspacejeu() {
        	spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(2, 2), new Position(4,8), 1);
